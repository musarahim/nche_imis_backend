...
class CertificationAndClassification(TimeStampedModel):
    ...
    # infrastructure
    classrooms = models.PositiveIntegerField(null=True, blank=False)
    libraries = models.PositiveIntegerField(null=False, blank=False)
    science_labs = models.PositiveIntegerField(null=False, blank=False)
    computer_labs = models.PositiveIntegerField(null=False, blank=False)
    staff_houses = models.PositiveIntegerField(null=False, blank=False)
    administrative_staff_area = models.PositiveIntegerField(null=True, blank=False)
    area_for_staff_use = models.PositiveIntegerField(null=False, blank=False)
    administrative_block_area = models.PositiveIntegerField(null=False, blank=False)
    student_Welfare_offices = models.PositiveIntegerField(null=False, blank=False)
    sick_bay_area = models.PositiveIntegerField(null=False, blank=False)
    hostels_area = models.PositiveIntegerField(null=False, blank=False)
    meeting_hall_area = models.PositiveIntegerField(null=False, blank=False)
    master_plan = models.FileField(upload_to='land_titles/', null=True, blank=False)
    # ground,physical infrastructure
    area_of_playground = models.PositiveIntegerField(null=False, blank=False)
    # type of playground
    available_playgrounds = models.CharField(max_length=255, null=False, blank=False)
    # Area of empty space (and within the campus dedicated to aesthetic and recreation use)
    area_of_empty_space = models.PositiveIntegerField(null=False, blank=False)
    total_roads_mileage = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=False)
    water_source = models.CharField(max_length=255, null=True, blank=False)
    power_source = models.CharField(max_length=255, null=True, blank=False)
    has_cultivable_land = models.BooleanField(null=True, blank=False)
    ...
    # Facilities
    library_books = models.PositiveIntegerField(null=False, blank=False)
    text_books = models.PositiveIntegerField(null=False, blank=False)
    publication_years = models.ManyToManyField(PublicationYear, blank=False)
    computers_in_use = models.PositiveIntegerField(null=False, blank=False)
    computers_in_library = models.PositiveIntegerField(null=False, blank=False)
    academic_staff_computers = models.PositiveIntegerField(null=False, blank=False)
    administrative_staff_computers = models.PositiveIntegerField(null=True, blank=False)
    library_computer_software = models.PositiveIntegerField(null=False, blank=False)
    #State whether students will access computers to locate reading materials in the library
    ...
    library_seats = models.PositiveIntegerField(null=False, blank=False)
    classroom_seats = models.PositiveIntegerField(null=False, blank=False)
    laboratories_seats = models.PositiveIntegerField(null=False, blank=False)
    administration_block_seats = models.PositiveIntegerField(null=False, blank=False)
    ...
    average_staff_student_ratio = models.CharField(null=False, blank=False)
    programme_staff_student_ratio = models.FileField(null=False, blank=False)
    staff_overload = models.CharField(null=False, blank=False)
    # administrative and support staff
    administrative_staff = models.PositiveIntegerField(null=True, blank=False)
    support_staff = models.PositiveIntegerField(null=True, blank=False)
    # names, qualifications and gender
    ...
    # student population
    total_number_of_students = models.PositiveIntegerField(null=False, blank=False)
    programme_distribution = HTMLField(null=True, blank=False)
    # Regions distribution
    eastern_students = models.PositiveIntegerField(null=False, blank=False)
    central_students = models.PositiveIntegerField(null=False, blank=False)
    northern_students = models.PositiveIntegerField(null=False, blank=False)
    western_students = models.PositiveIntegerField(null=False, blank=False)
    # Non Ugandan Students
    east_africans_students = models.PositiveIntegerField(null=False, blank=False)
    other_students = models.PositiveIntegerField(null=False, blank=False)
