...
class EmployeeSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        ...
        response['district_name'] = instance.district.name if instance.district else None
        response['county_name'] = instance.county.name if instance.county else None
        response['sub_county_name'] = instance.sub_county.name if instance.sub_county else None
        response['parish_name'] = instance.parish.name if instance.parish else None
        response['village_name'] = instance.village.name if instance.village else None
        response['district_of_origin_name'] = instance.district_of_origin.name if instance.district_of_origin else None
        response['county_of_origin_name'] = instance.county_of_origin.name if instance.county_of_origin else None
        response['sub_county_of_origin_name'] = instance.sub_county_of_origin.name if instance.sub_county_of_origin else None
